...
print()
print("=" * 55)
print("        PROJECT 24 - VALIDATED JEWELLERY RAG")
print("=" * 55)

print()
print("Products + Policies + Answer Validation")
...
while True:
    ...
    # ========================================================
    #
    # Semantic search is NEVER allowed to introduce a product
    # that failed metadata filtering.
    # ========================================================
    ...
    results = [
        result
        for result in results
        if result["product"]["id"] in allowed_product_ids
    ]
    ...
    try:
        ...
        if is_valid:
            ...
            print(
                "Product names, IDs, prices and karats "
                "passed validation."
            )
